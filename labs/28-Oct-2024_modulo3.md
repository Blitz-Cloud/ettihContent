...
Acest cod C este un program foarte simplu care afișează mesajul "Hello, World!" în consolă. Iată o explicație detaliată:
...
*   `printf("Hello, World!\n");`: Această linie este cea care face treaba.
    *   `printf()`: Este o funcție din biblioteca standard C care este folosită pentru a afișa text (și alte tipuri de date) în consolă.  `printf` înseamnă "print formatted".
...
Programul afișează mesajul "Hello, World!" în consolă și apoi se termină.  Acesta este un program clasic folosit adesea ca prim exemplu în introducerile în programare, deoarece demonstrează structura de bază a unui program C și modul de afișare a textului.
